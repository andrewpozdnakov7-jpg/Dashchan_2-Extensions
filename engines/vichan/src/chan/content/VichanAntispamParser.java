...
public class VichanAntispamParser {
    ...
    private VichanAntispamParser(String source, RequestEntity entity, String... ignoreFields) throws ParseException {
    ...
    public static void parseAndApply(String source, RequestEntity entity, String... ignoreFields)
        ...
        new VichanAntispamParser(source, entity, ignoreFields);
    }

    private static final TemplateParser<VichanAntispamParser> PARSER = TemplateParser.<VichanAntispamParser>builder()
