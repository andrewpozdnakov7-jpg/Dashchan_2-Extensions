...
import io.dashchan2.chan.fourchan.R;
...
public class FourchanChanConfiguration extends ChanConfiguration {
	...
	private static final String KEY_ARCHIVE_ENABLED = "archive_enabled";
	...
	public Board obtainBoardConfiguration(String boardName) {
		...
		board.allowArchive = get(boardName, KEY_ARCHIVE_ENABLED, false);
	...
	public chan.content.model.Board updateBoard(JsonSerial.Reader reader) throws IOException, ParseException {
		...
		while (!reader.endStruct()) {
			switch (reader.nextName()) {
				...
				case "is_archived": {
					archiveEnabled = reader.nextBoolean();
					break;
				}
				default: {
					reader.skip();
		...
		if (boardName != null && title != null) {
			...
			set(boardName, KEY_ARCHIVE_ENABLED, archiveEnabled);
